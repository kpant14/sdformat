 ...
 *
 */
#ifndef SDF_NAVSAT_MULTIPATH_HH_
#define SDF_NAVSAT_MULTIPATH_HH_
...
namespace sdf
{
  ...
  ///
  /// ~~~{.xml}
  /// <sensor name="navsat_sensor" type="navsat_multipath">
  ...
  /// </sensor>
  /// ~~~
  class SDFORMAT_VISIBLE NavSatMultipath
  {
    /// \brief Default constructor
    public: NavSatMultipath();
    ...
    public: bool operator==(const NavSatMultipath &_navsat) const;
